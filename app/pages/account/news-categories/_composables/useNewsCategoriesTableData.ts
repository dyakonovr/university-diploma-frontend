...
import { getNewsCategories } from '~/domain/news-category/api/news-categories.api';
...
function useNewsCategoriesTableData(options?: {
  ...
  const data = ref<NewsCategory[] | null>(null);
...
export default useNewsCategoriesTableData;
